...
//JSON DATA
/*
    URL:https://api.coingecko.com/api/v3/coins/bitcoin?localization=fasle&tickers=false&market_data=false&community_data=false&developer_data=false&sparkline=false
    ...
    RESPONSE:
 {
   ...
   "sentiment_votes_up_percentage": 66.26,
   "sentiment_votes_down_percentage": 33.74,
   "watchlist_portfolio_users": 1335504,
   "market_cap_rank": 1,
   "coingecko_rank": 1,
...
struct CoinDetailModel: Codable {
    ...
    enum CodingKeys: String, CodingKey  {
        case id, symbol , name , links , description , categories
